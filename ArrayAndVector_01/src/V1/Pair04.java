...
public class Pair04 {
	...
	public static void main(String[] args) {
		int arr[]={1, 2, 3, 4, 5, 6};
		int target=7;//{2,3,5,9,10,11}
		System.out.println(findpair2(arr, target));
	}
	//sorting then binary search-O(nlogn)
...
//	using data structure that is Hashset O(n)--otimal solution because O(nlogn)>O(n)
	//so sorting is the bottleneck proble .because it increase the time complexity
